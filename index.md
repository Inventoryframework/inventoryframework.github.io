...
# What is the InventoryFrameworkPlugin?
...
3. Data asset which only shows relevant information to your desired rules with inbuilt functions and [instanced objects](http://localhost:5000/classes-and-settings/o_masterobject/) that can have custom  variables per data asset.
...
You can look at the FAQ below for more info.

<span style="color:cyan">some *blue* text</span>.

Color Sheet: [!badge variant="danger" text="Functions"] - [!badge variant="primary" text="Variables"] - [!badge variant="success" text="Category"] - [!badge variant="secondary" text="Class"] - Interface.